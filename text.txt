...
#фоновая музыка 
mixer.init() 
mixer.music.load('тен.ogg') 
mixer.music.play() 


#создания мяча и ракетки    
racket1 = Player('racket3.png', 30, 200, 4, 100, 150) # при созданни спрайта добавляется еще два параметра
racket2 = Player('racket2.png', 470, 200, 4, 100, 150)
